		...
		<div class="container">
			<div class="col-md-4 products-left">
				...
				{{-- <div class="men-position animated wow slideInUp" data-wow-delay=".5s">
					<a href="#"><img src="{{asset('frontend_assests/images/29.jpg')}}" alt=" " class="img-responsive" /></a>
			...
			<div class="col-md-8 single-right">
				<div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="{{asset('frontend_assests/images/sandal.jpg')}}">
								<div class="thumb-image"> <img src="{{ $product_detail->photo }}" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							{{-- <li data-thumb="{{asset('frontend_assests/images/sandal1.jpg')}}">
								 <div class="thumb-image"> <img src="{{asset('frontend_assests/images/sandal1.jpg')}}" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="{{asset('frontend_assests/images/sandal2.jpg')}}">
							   <div class="thumb-image"> <img src="{{asset('frontend_assests/images/sandal2.jpg')}}" data-imagezoom="true" class="img-responsive"> </div>
							</li>  --}}
						</ul>
					</div>
					<!-- flixslider -->
						<script defer src="{{asset('frontend_assests/js/jquery.flexslider.js')}}"></script>
						<link rel="stylesheet" href="{{asset('frontend_assests/css/flexslider.css')}}" type="text/css" media="screen" />
						<script>
								...
								<div class="bootstrap-tab-text-grids">
									<div class="bootstrap-tab-text-grid">
										<div class="bootstrap-tab-text-grid-left">
											<img src="{{asset('frontend_assests/images/4.png')}}" alt=" " class="img-responsive" />
										</div>
									...
									<div class="bootstrap-tab-text-grid">
										<div class="bootstrap-tab-text-grid-left">
											<img src="{{asset('frontend_assests/images/5.png')}}" alt=" " class="img-responsive" />
										</div>
										<div class="bootstrap-tab-text-grid-right">
											<ul>
												<li><a href="#">Admin</a></li>
